...
<div class="container pb-6 pt-6">
	<?php
		...
		$id = (isset($_GET['product_id_entrada'])) ? $_GET['product_id_entrada'] : 0;
	...
	<form action="./php/producto_entrada.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="columns">
			...
			<div class="column">
		    	<div class="control">
					<label>Marca</label>
				  	<input class="input" type="text" name="producto_marca" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="25" required value="<?php echo $datos['producto_marca']; ?>" >
				</div>
		  	</div>
