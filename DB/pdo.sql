...
CREATE TABLE `proveedor` (
  ...
  `proveedor_nombre` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
  `proveedor_telefono` int(15) NOT NULL,
  `proveedor_correo` varchar(70) COLLATE utf8_spanish2_ci NOT NULL,
  `proveedor_direccion` varchar(150) COLLATE utf8_spanish2_ci NOT NULL,
...
ALTER TABLE `proveedor`
  MODIFY `proveedor_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
